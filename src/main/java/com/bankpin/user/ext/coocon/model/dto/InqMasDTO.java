...
public class InqMasDTO {
    ...
    public static class RequestParams {
        ...
        public static class InList1 {
            ...
            public static InList1 agreeLstToInList(CooconCustAgreeLstDTO.Create create) {
                return InList1.builder()
                        .agrmtItCd(create.getCustAgreeItmCd())
                        .agrmtDT(create.getSelfAgreeDttm())
                        .agrmtYN(create.getSelfAgreeYn())
                        .build();
            }
