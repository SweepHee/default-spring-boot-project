...
public enum ApiProperties {
    ...
    private static final String uri = "https://vaoaapi-test.coocon.co.kr/"; // API주소 (테스트사용중);
//    "https://vaoaapi.coocon.co.kr/"

    public static String requestURI(ApiProperties property) {
